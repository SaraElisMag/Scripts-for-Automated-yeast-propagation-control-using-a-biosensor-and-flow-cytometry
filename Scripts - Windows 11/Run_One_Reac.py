import warnings
from FCS_Handling import fcs_analysis
import Pump_Handling as pmp
# import Pump_Mock as pm
import time
...
class FileHandler(FileSystemEventHandler):
    ...
    def on_created(self, event):
        ...
        if self.file_counter % 2 == 0:
            ...
            self.analysis_results = fcs_analysis(file_path)
            self.save_results()
            self.plot_results()
            self.get_slope()
            self.use_pump()
    ...
    def plot_results(self):
        plt.ion()
        self.fig1, (self.ax1, self.ax2, self.ax3) = plt.subplots(3, 1, sharex='col')
        self.fig1.set_figheight(8.5)
        self.fig1.set_figwidth(8.5)
    ...
    def save_to_folder(self):
        ...
        save_to = r"C:\Users\saram\OneDrive\Dokument\Examensarbete 2023\Data\Saved"

        folder_name = time_string  # Assuming time_string is the desired folder name
...
folder_path = r"C:\Users\saram\OneDrive\Dokument\Examensarbete 2023\Data\Goal"
...
atexit.register(event_handler.save_to_folder)
